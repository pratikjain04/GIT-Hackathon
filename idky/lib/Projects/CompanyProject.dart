...
List<CompanyProject> companyProjects = [
  ...
  CompanyProject(
      ...
      'Web Development',
      'automate the existing manual system with the help of advance computerized software',
  ...
  CompanyProject(
      ...
      'Web Development',
      'Counselling different types of activities such as guiding students towards colleges and universities',
  ...
  CompanyProject(
      ...
      'Diceus',
      'Web Development',
      'To provide computerized data storage facilit',
  ...
  CompanyProject(
      ...
      'Intellectsoft',
      'Web Development',
      'This system consists of content filtering, collaborative filtering and association rule mining to produce efficient recommendations.',
  ...
  CompanyProject(
      ...
      'Iflexion',
      'Web Development',
      'This is Total Quality Management Project Report',
  ...
  CompanyProject(
      ...
      'Bastille',
      'Internet of Things',
      'Presented here is a project that lets your Raspberry Pi (RPi) turn into an IoT based smart camera',
  ...
  CompanyProject(
      ...
      'Filament Networks',
      'Internet of Things',
      'Presented here is a IoT enabled air pollution meter to monitor air quality on your smartphone',
  ...
  CompanyProject(
      ...
      'Microsoft.',
      'Internet of Things',
      'Microsoft brings in added flavour to IoT using cloud connectivity and support',
  ...
  CompanyProject(
      ...
      'FogHorn',
      'Internet of Things',
      'Want to send text from your Android phone to your Arduino?',
  ...
  CompanyProject(
      ...
      'Hologram',
      'Internet of Things',
      'This project brings in a Raspberry Pi for people working with development boards.',
  ...
  CompanyProject(
      ...
      'Uber',
      'App Development',
      'Number plate recognition is a form of automatic vehicle identification.',
  ...
  CompanyProject(
      ...
      'google',
      'App Development',
      ' An Android Chatbot is build using algorithm that analyzes user’s queries and understand user’s message',
  ...
  CompanyProject(
      ...
      'Simpalm',
      'App Development',
      'Android Screen Camera is a re sizable floating camera that can be accessed from anywhere in the launcher or in any window',
  ...
  CompanyProject(
      ...
      'Y Media Labs',
      'App Development',
      'This System is an innovative Application allowing the System to take the usage from Build-in classes and put a list in front of the user for him to review',
  ...
  CompanyProject(
      ...
      'Twitter',
      'Machine Learning',
      'Social media platform Twitter generate huge amounts of big data that can be mined in various ways to understand trends, public sentiments and opinions ',
  ...
  CompanyProject(
      ...
      'Walmart',
      'Machine Learning',
      'Walmart dataset has sales data for 98 products across 45 outlets',
  ...
  CompanyProject(
      ...
      'amazon',
      'Machine Learning',
      'This is an interesting machine learning project idea for data scientists/machine learning engineers working or planning to work with finance domain',
  ...
  CompanyProject(
      ...
      'Jack and Daniels',
      'Machine Learning',
      'It’s a known fact that older the wine, better the taste',
  ...
  CompanyProject(
      ...
      'Marketing',
      "There's a holiday in nearly every month, such as New Year's Day in January, Valentines Day in February, and St. Patrick's Day in March, right up through Christmas in December.",
  ...
  CompanyProject(
      ...
      'IBM iX',
      'Marketing',
      'Trades shows were a 13 billion industry in the U.S. as of November 2012, according to IBISWorld, a marketing research firm.',
  ...
  CompanyProject(
      ...
      'Deloitte Digital',
      'Marketing',
      'Designing new promotional materials is a project with lasting results',
  ...
  CompanyProject(
      ...
      'Dentsu',
      'Marketing',
      "Getting your name 'out there' happens when it's on the back of a sports team's uniform",
  ...
  CompanyProject(
      ...
      'Landor',
      'Designing',
      "New Zealand designer Sara Marshall won a student design award for her tongue-in-cheek reinterpretations of popular logos.",
  ...
  CompanyProject(
      ...
      'Meta Design',
      'Designing',
      "Toronto design studio Fook Communications shows off a range of skills with their Berlin Travel Book, a neatly packaged little guide to Germany’s capital city",
